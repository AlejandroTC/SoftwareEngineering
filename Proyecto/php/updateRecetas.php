...
try {
    ...
    $stmt = $conn->prepare('UPDATE recetas SET nombre = :nombre, duracion = :duracion, tiempo_comida = :tiempo_comida, tiempo_receta = :tiempo_receta, porciones = :porciones, imagen = :imagen WHERE id = :receta_id');
